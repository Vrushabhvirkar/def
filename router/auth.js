...
const sgMail = require('./sgMailMailgun'); // Adjust the path based on your project structure

sgMail.setApiKey(process.env.MAILGUN_API_KEY, process.env.MAILGUN_DOMAIN);
